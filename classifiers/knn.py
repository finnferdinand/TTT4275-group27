...
class NN(Classifier):
    ...
    def plot_misclassified(self, selection_size):
        ...
        self.is_correctly_classified = False
    ...
    def plot_correctly_classified(self):
        ...
        self.is_correctly_classified = True
    ...
    def _plot_selection(self, data, classified_labels, correct_labels):
        ...
        plt.suptitle(("Correctly classified labels" if self.is_correctly_classified else "Misclassified labels") 
                     + f" using {self.num_chunks} chunks using {self.k}NN"
